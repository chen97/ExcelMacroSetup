...
#define AppID "Kent_MOExtensions_" + AppGUID
...
; SignTool=signtool sign /v /s ABC /n $qKent ACME$q /t http://timestamp.verisign.com/scripts/timstamp.dll /d $qCertification MicrosoftOfficeExtensions$q $f
